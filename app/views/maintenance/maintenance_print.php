...
<head>
  <meta charset="utf-8">
  <title>Docket ID - <?= $visit["maintenance_id"] ?></title>
</head>
<style>
  a {
    color: #0087C3;
...
<body>
  <header class="clearfix">
    <div id="topbar">
      <a href="<?= app('url') ?>/exec/maintenance/printPdf/?view_type=pdf&frm_maintenance_id=<?= $visit["maintenance_id"] ?>" id="printPdf">Print As PDF</a>
    </div>
    <table>
      <tr>
        <td id="logo">
  ...
  <main>
    ...
    <div style="border:0px solid black;min-height:600px;padding:10px;">
      <p>
