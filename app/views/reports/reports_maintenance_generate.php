...
<div id="printArea" contenteditable="true">
    ...
    <div id="dear">
        ...
        <input id="startDate" type="hidden" value="<?= date("d-M-Y", $start_date) ?>">
        <input id="endDate" type="hidden" value="<?= date("d-M-Y", $end_date) ?>">
    </div>
    ...
    <table width="100%" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" id="maintable">
        ...
        <tr>
            ...
            <td align="">
                <div style="margin-left:5px;margin-right:5px"><?= typeNames($row["service_type_ids"]) ?></div>
            </td>
            <td align="">
                <div style="margin-left:5px;margin-right:5px"><?= $row["maintenance_notes"] ?></div>
            </td>
...
<script>
    $(document).ready(function() {
        $('#maintable').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    title: 'Maintenance report: ' + $('#startDate').val() + '-' + $('#endDate').val()
                },
                {
                    extend: 'pdf',
