...
<div id="printArea" contenteditable="true">
    ...
    <thead>
        <tr>
        <td align="center" width="20px"><strong>Maintenance Date</strong></td>
        <td align="center" width="20px"><strong>Year</strong></td>
        <td align="center" width="20px"><strong>Month</strong></td>
        <td align="center" width="20px"><strong>Week</strong></td>			            
        <td align="center" width="20px"><strong>Lift</strong></td>
        <td align="center" width="200px"><strong>Weekly Tasks</strong></td>            
        <td align="center"><strong>Notes</strong></td>
        <td align="center" width="100px"><strong>Technician</strong></td>
        <td align="center" width="20px"><strong>Maintenance ID</strong></td>
        </tr>
    </thead>
    </tbody>
